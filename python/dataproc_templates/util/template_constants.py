...
ES_BT_PROJECT_ID = "es.bt.project.id"
ES_BT_INSTANCE_ID = "es.bt.instance.id"
ES_BT_CREATE_NEW_TABLE = "es.bt.create.new.table"
ES_BT_BATCH_MUTATE_SIZE = "es.bt.batch.mutate.size"
