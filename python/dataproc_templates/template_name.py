...
class TemplateName(Enum):
    ...
    BIGQUERYTOELASTICSEARCH = "BIGQUERYTOELASTICSEARCH"
    ...
    MONGOTOBIGQUERY = "MONGOTOBIGQUERY"
    ...
    ELASTICSEARCHTOGCS = "ELASTICSEARCHTOGCS"
    ELASTICSEARCHTOBQ = "ELASTICSEARCHTOBQ"
    ELASTICSEARCHTOBIGTABLE = "ELASTICSEARCHTOBIGTABLE"
