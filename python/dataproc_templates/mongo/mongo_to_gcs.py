...
class MongoToGCSTemplate(BaseTemplate):
    ...
    def parse_args(args: Optional[Sequence[str]] = None) -> Dict[str, Any]:
        ...
        add_spark_options(parser, constants.MONGO_GCS_OUTPUT_SPARK_OPTIONS)
    ...
    def run(self, spark: SparkSession, args: Dict[str, Any]) -> None:
        ...
        spark_write_options = spark_options_from_template_args(args, constants.MONGO_GCS_OUTPUT_SPARK_OPTIONS)
