...
```
bin/start.sh \
--templateProperty jdbctojdbc.input.url="jdbc:postgresql://1.1.1.1:5432/test?user=test&password=password" \
--templateProperty jdbctojdbc.input.driver="org.postgresql.Driver" \
--templateProperty jdbctojdbc.input.table="(select * from employees) as employees" \
--templateProperty jdbctojdbc.output.url="jdbc:postgresql://1.1.1.1:5432/test?user=test&password=password" \
--templateProperty jdbctojdbc.output.driver="org.postgresql.Driver" \
--templateProperty jdbctojdbc.output.table="employees_output" \
--templateProperty jdbctojdbc.input.partitioncolumn="id" \
--templateProperty jdbctojdbc.input.lowerbound="11" \
--templateProperty jdbctojdbc.input.upperbound="20" \
--templateProperty jdbctojdbc.numpartitions="4" \
--templateProperty jdbctojdbc.output.mode="Overwrite" \
--templateProperty jdbctojdbc.output.batch.size="100" \
--templateProperty jdbctojdbc.output.create.table.option="PARTITION BY RANGE(id);CREATE TABLE po0 PARTITION OF employees_out FOR VALUES FROM (MINVALUE) TO (5);CREATE TABLE po1 PARTITION OF employees_out FOR VALUES FROM (5) TO (10);CREATE TABLE po2 PARTITION OF employees_out FOR VALUES FROM (10) TO (15);CREATE TABLE po3 PARTITION OF employees_out FOR VALUES FROM (15) TO (MAXVALUE);" 
...
bin/start.sh \
-- --template JDBCTOJDBC \
--templateProperty jdbctojdbc.input.url="jdbc:sqlserver://1.1.1.1:1433;databaseName=test;user=test;password=password" \
--templateProperty jdbctojdbc.input.driver="com.microsoft.sqlserver.jdbc.SQLServerDriver" \
--templateProperty jdbctojdbc.input.table="employees" \
--templateProperty jdbctojdbc.output.url="jdbc:sqlserver://1.1.1.1:1433;databaseName=test;user=test;password=password" \
--templateProperty jdbctojdbc.output.driver="com.microsoft.sqlserver.jdbc.SQLServerDriver" \
--templateProperty jdbctojdbc.output.table="employees_output" \
--templateProperty jdbctojdbc.output.mode="Overwrite" \
--templateProperty jdbctojdbc.output.batch.size="1000"
```
...
bin/start.sh \
-- --template JDBCTOJDBC \
--templateProperty jdbctojdbc.input.url="jdbc:oracle:thin:@//1.1.1.1:1521/mydb?user=test&password=password" \
--templateProperty jdbctojdbc.input.driver="oracle.jdbc.driver.OracleDriver" \
--templateProperty jdbctojdbc.input.table="employees" \
--templateProperty jdbctojdbc.output.url="jdbc:oracle:thin:@//1.1.1.1:1521/mydb?user=test&password=password" \
--templateProperty jdbctojdbc.output.driver="oracle.jdbc.driver.OracleDriver" \
--templateProperty jdbctojdbc.output.table="employees_with_pk" \
--templateProperty jdbctojdbc.output.primary.key="id"
```
...
--templateProperty jdbctojdbc.output.url="jdbc:postgresql://1.1.1.1:5432/test?user=test&password=password" \
--templateProperty jdbctojdbc.output.driver="org.postgresql.Driver" \
--templateProperty jdbctojdbc.output.table="employees_mysql"
```
...
--templateProperty jdbctojdbc.input.driver="com.mysql.cj.jdbc.Driver" \
--templateProperty jdbctojdbc.input.table="employees" \
--templateProperty jdbctojdbc.output.url="jdbc:sqlserver://1.1.1.1:1433;databaseName=test;user=sqlserver;password=password" \
--templateProperty jdbctojdbc.output.driver="com.microsoft.sqlserver.jdbc.SQLServerDriver" \
--templateProperty jdbctojdbc.output.table="employees_mysql"
```
