...
public class KafkaToPubSubForEach implements BaseTemplate, Serializable {
  private static final Logger LOGGER = LoggerFactory.getLogger(KafkaToPubSubForEach.class);
