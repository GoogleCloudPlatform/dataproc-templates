...
import org.apache.spark.sql.funtions.from_json;
...
public class KafkaToBQ implements BaseTemplate {
  ...
  public KafkaToBQ() {
	  BqOutputDataset = getProperties().getProperty(KAFKA_GCS_OUTPUT_LOCATION);
	  BqOutputTable =
    ...
    try {
      ...
      processedData =
          inputData
              ...
              .withColumn("value", from_json(inputData.col("value").cast(DataTypes.StringType)));
